"""
v11 版本：Sweep candidate watermark scales with batched in-process decoding.

使用 v11 解码器（3环：r=12, r=18, r=25）。

用法:
    python sweep_decode_channel_watermark_v11.py \
        --input_dir /mnt/lpl/fftmask/watermarked_output_cb_v11 \
        --bits_file /mnt/lpl/fftmask/watermarked_output_cb_v11/embed_gt_mapping.json \
        --model_path /mnt/lpl/fftmask/output/finetune_v11/20260723_121008/models/best_cb_decoder_v11.pth
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="v11: Sweep candidate watermark scales with batched in-process decoding."
    )
    ...
    parser.add_argument("--model_path", type=str,
                        ...
                        help="Path to v11 decoder model")
    ...
    results_path = os.path.join(output_dir, "sweep_results_v11.json")
