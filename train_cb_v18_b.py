"""
v18 B通道镂空训练 - 纯pair噪声版

与Cb通道版本的区别：水印嵌入B通道而非Cb通道

用法:
    python train_cb_v18_b.py --config config/train_cb_v18_b_pair.yaml
"""
...
from dataset_v18_b import WatermarkDatasetV18 as WatermarkDatasetV11
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler('train_cb_v18_b.log')
    ]
)
...
def main():
    parser = argparse.ArgumentParser(description='v18 B通道镂空训练 - 纯pair噪声')
    ...
    logger.info("=" * 60)
    logger.info("v18 B通道镂空训练 - 纯pair噪声")
    logger.info("=" * 60)
