...
与Cb通道版本的区别：水印嵌入B通道而非Cb通道

用法:
    python train_cb_v17_b.py --config config/train_cb_v17_b_pair.yaml
"""
...
from dataset_v17_b import WatermarkDatasetV17
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler('train_cb_v17_b.log')
    ]
)
...
def main():
    parser = argparse.ArgumentParser(description='v17 B通道训练 - 纯pair噪声')
