...
class WatermarkDataset(Dataset):
    ...
    def __init__(self, image_dir, block_size=512, num_bits=4, r=[3,6], bits=[5,15], alpha_embed=0.01, transform=None):
        ...
        self.watermark_system = Watermark16Sector1(L1=block_size, k1=30000, r=r, bits=bits, r_range=0,n_sectors=num_bits) #2gaiwei1
    ...
    def __getitem__(self, idx):
        ...
        markimg=host_bgr*(1-self.alpha_embed)+Tm*self.alpha_embed
